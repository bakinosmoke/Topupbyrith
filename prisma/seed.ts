...
async function main() {
  console.log("✨ Seeding AURAPLAY database...");

  // --- Settings singleton (UPDATED WITH YOUR CONTACTS) ---
  await prisma.settings.upsert({
    ...
    create: {
      ...
      siteName: "AURAPLAY",
      exchangeRate: 4100,
      supportTelegram: "@Dark_is_the_nigth",      // Your Telegram
      supportEmail: "ffrie414@gmail.com",         // Your Gmail
    },
  });

  // --- Admin user ---
  const adminEmail = process.env.ADMIN_EMAIL || "admin@auraplay.com";
